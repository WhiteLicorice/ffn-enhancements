...
(function () {
    ...
    const DarkMode = {
        storageKey: 'ffn_enhancements_dark_mode',
        isActive: false,
        LIGHT_ICON: '☀️',
        DARK_ICON: '🌙',
        ...
        loadState: function () {
            ...
            if (stored !== null) {
                ...
                Core.log('DarkMode', `Loaded from storage: ${this.isActive}`);
            } else {
                if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
                    this.isActive = true;
                    Core.log('DarkMode', 'System Preference: Dark');
                } else {
                    this.isActive = false;
                }
            }
        ...
        replaceMobileIcon: function () {
            ...
            if (!target) {
                Core.log('DarkMode', 'Mobile icon not found. Using fallback injection.');
                this.fallbackInject();
                return;
            }
        ...
        fallbackInject: function () {
            // Put it near the search bar if mobile icon is missing
            const anchor = document.querySelector('#top input[name="keywords"]');
            const container = anchor ? anchor.parentNode : document.querySelector('#top');
        ...
        toggle: function () {
            ...
            const btn = document.querySelector('#ffn-dark-toggle-btn');
            if (btn) btn.innerHTML = this.isActive ? this.LIGHT_ICON : this.DARK_ICON;
