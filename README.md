...
Once you have the extension installed, go to the [Releases](https://github.com/WhiteLicorice/ffn-enhancements/releases) page. Click the `ffn-enhancements.user.js` file found under the latest release. Your userscript manager should automatically prompt you to confirm the installation.
